# 📈 Stock Agent: 具备双轨记忆与多级缓存的企业级量化智能体架构

Stock Agent 是一个基于 LangChain 核心框架构建的本地化全栈量化分析智能体。

本项目摒弃了市面上常见的“单体 Prompt 脚本”或“简单 API 套壳”模式，旨在展示**构建高可用、高扩展、具备复杂业务落地能力的 AI Agent 的标准工程实践**。系统深度整合了**动态多工具路由**、**双轨记忆架构 (STM + LTM)**、**高性能混合持久化 RAG 引擎**以及**企业级沙箱安全防御**。
